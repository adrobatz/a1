...
<?php
$quotes = array("'You’re a wizard, Harry.'― J.K. Rowling (Hagrid), Harry Potter and the Philosopher’s Stone", "We could all have been killed. Or worse, expelled. -J.K. Rowling (Hermione), Harry Potter and the Philosopher’s Stone", "'It’s wingardium leviOsa, not leviosAH.'– J.K. Rowling (Hermione), Harry Potter and the Philosopher’s Stone"), "'Just because you have the emotional range of a teaspoon doesn’t mean we all have.'― J.K. Rowling (Hermione), Harry Potter and the Order of the Phoenix";
